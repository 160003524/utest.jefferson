...
public class UTestData {
    ...
    public void setStrFirstName(String strFistName) {
        this.strFirstName = strFistName;
    }
    ...
    public void setStrUserLanguage(String strUserLanguage) {
    ...
    public void setStrOsVersion(String strOsVersion) {
